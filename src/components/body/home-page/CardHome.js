...
function CardHome(props) {
    ...
    return ( <
        motion.div className = "highlight-topic container-fluid"
        initial = "out"
        animate = "in"
        exit = "out"
        ...
        div className = "offset-md-1 col-md-11 footer-card-home" > { <
            ...
            onClick = {
                () => localStorage.setItem("slugUniversity", id)
            } //pass id university to localStorage so that it resolve matching url at detail-university/index directory
            >
            Chi tiết <
            /NavLink>
        } <
